...
function arrayEquals(arr1: Uint8Array | number[], arr2: Uint8Array | number[]) {
...
function arrayCompare(arr1: Uint8Array | number[], arr2: Uint8Array | number[]) {
  for (let i = 0; i < arr1.length; i++) {
...
function arrayZero(arr: Uint8Array | number[]): boolean {
